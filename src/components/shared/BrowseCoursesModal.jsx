...
const BrowseCoursesModal = ({ isOpen, onClose }) => {
  ...
  const [dynamicCategories, setDynamicCategories] = useState(
    categoryTemplates.map((cat) => ({ ...cat, count: "0 courses" })),
  );
              ...
              <div>
                ...
                <div className="space-y-3 md:space-y-4">
                  {dynamicCategories.map((cat, idx) => (
                    ...
                    >
                      <div
                        className={`${cat.color} p-2.5 md:p-3 rounded-xl text-white shadow-sm`}
                      >
                        {cat.icon}
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-[#64748B]">{cat.count}</p>
                      </div>
                    </div>
                  ))}
                </div>
