  ...
  <div className="w-full lg:w-[330px] space-y-4 lg:sticky lg:top-[100px]">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[13px] font-black text-[#1C1C1C] leading-snug">
              Door Supervisor Training – Flexi+
            </p>
          ...
          <div className="text-right shrink-0">
            <p className="text-[10px] text-[#F15A24] font-bold cursor-pointer hover:underline">
              Change package
            </p>
    ...
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 text-center">
      ...
      <div className="flex justify-center items-center gap-2 mb-4">
        ...
        <span className="text-[10px] font-black text-[#1C1C1C]">
          Trustpilot
        </span>
      </div>
