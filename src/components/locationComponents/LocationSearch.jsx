                ...
                <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 w-full md:w-auto">
                  ...
                  <div className="relative flex-1 lg:w-110">
                    ...
                    <input
                      ...
                      className="w-full h-14 pl-12 md:pl-16 pr-10 rounded-2xl border border-gray-200 bg-[#FAFBFD] focus:bg-white focus:border-orange-400 focus:ring-4 focus:ring-orange-100 outline-none transition-all text-base font-medium text-gray-700 placeholder:text-gray-400"
                    />
                    {searchInput && (
                      <button
                        type="button"
