    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#243443] via-[#1f2f3f] to-[#16222c] py-24 px-6 text-center">
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12">
          ...
          {/* Primary Button */}
          <button className="bg-[#F15A24]  hover:bg-[#a6e64c] text-[#1f2f3f] font-semibold px-8 py-4 rounded-full shadow-lg transition flex items-center justify-center gap-3">
            <Phone size={18} />
            Call 0800 XXX XXXX
          </button>
