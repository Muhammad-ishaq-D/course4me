...
const TrainingPreviewSection = () => {
  ...
  return (
    <div className="max-w-[1240px] mx-auto px-4 sm:px-6 py-16 sm:py-20 ">
      {/* Header Area */}
      <div className="mb-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-gray-500 text-base sm:text-lg font-regular leading-relaxed">
              No surprises. Get a real look at our courses, meet the
              instructors, and understand exactly what you're signing up for —
        ...
        >
          ...
          <div className="relative z-20 p-8 sm:p-10">
            ...
            <p className="text-gray-300 text-sm sm:text-base mb-6 leading-relaxed max-w-md opacity-90">
              Learn from the best. John brings 20+ years of security experience
            ...
            <div className="flex flex-wrap gap-2.5">
              {[
                ...
                <span
                  key={tag}
                  className="px-4 py-1.5 bg-white/10 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-widest rounded-lg border border-white/10"
                >
                  {tag}
                </span>
              ))}
              ...
              >
                ...
                <div className="flex-1 flex flex-col py-1">
                  <h4 className="text-lg font-bold text-[#1A1A1A] mb-1.5 tracking-tight group-hover:text-[#FF5421] transition-colors">
                    Instructor:{" "}
                    {course.id === "cctv-training"
                      ? "Richard Clarke"
                      : course.id === "security-guard"
                        ? "Sarah Mitchell"
                        : "David Okonkwo"}
                  </h4>
      ...
      <div className="mt-16 bg-[#1A1A1A] rounded-[40px] p-8 sm:p-12 flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden text-center lg:text-left">
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <p className="text-gray-400 text-base sm:text-lg font-medium opacity-80">
            Join 400,000+ professionals. Book your course today and get same-day
            exam results.
          </p>
        </div>
