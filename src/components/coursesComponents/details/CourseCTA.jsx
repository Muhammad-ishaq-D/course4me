    ...
    <section className="py-24 bg-[#1C1C1C] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <button
          ...
          className="bg-[#F15A24] text-white px-10 py-5 rounded-full font-black text-xl hover:brightness-110 transition-all shadow-2xl shadow-[#F15A24]/40 flex items-center gap-3 mx-auto group"
        >
